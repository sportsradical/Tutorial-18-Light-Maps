...
ID3D11ShaderResourceView** ModelClass::GetTextureDifusse1()
{
	return m_Texture->GetTexture();
}

ID3D11ShaderResourceView** ModelClass::GetTextureDifusse2()
{
...
bool ModelClass::LoadTextures(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename1, char* filename2)
{
	...
	// Initialize the texture array object.
	result = m_Texture1->Initialize(device, deviceContext, filename2);
	if (!result)
	{
		return false;
	}
